...
// import React, { Component } from "react";
// import { _filter, debounce } from "lodash.debounce";
...
//       <div className="App">
//         <header className="App-header">
//           <h2 className="App-title">| Creatures Cards |</h2>
//         </header>
//         <button style={{ margin: "20px auto" }} onClick={this.handleSubmit}>
//           Display Creature Cards
//         </button>
//         <FilterChip 
//           cardsByName={this.loadNextCards}
//           cardsBySet={cardsBySet} 
//           cardsByArtist={cardsByArtist} 
//           cardsByOriginalType={cardsByOriginalType} 
//         />
...
//           <React.Fragment>
//             <ScrollingCards 
//             cards={this.loadNextCards} 
//             name={this.loadNextCards}
//             sets={cardsBySet}
//             artist={cardsByArtist}
//             originalType={cardsByOriginalType}
//              />
//           </React.Fragment>
//         )}
//         {error && <div style={{ color: "#900" }}>{error}</div>}
